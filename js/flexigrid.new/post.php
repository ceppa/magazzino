...
function runSQL($rsql) {
	...
	$connect = ($GLOBALS["___mysqli_ston"] = mysqli_connect($db[$active_group]['hostname'], $db[$active_group]['username'], $db[$active_group]['password'])) or die ("Error: could not connect to database");
	$db = ((bool)mysqli_query($GLOBALS["___mysqli_ston"], "USE " . $db[$active_group]['database']));
	
	$result = mysqli_query($GLOBALS["___mysqli_ston"], $rsql) or die ('test');
	return $result;
