							...
							.click(
								function (e) 
									{ 
										...
										if (p.onRowSelectedClick && $(this).hasClass('trSelected'))
										{
											p.onRowSelectedClick($(this)[0].id,$(this),$(this).parent().parent().parent());
										}
										else
										...
										{
										    p.onRowSelected($(this)[0].id,$(this),$(this).parent().parent().parent());
										}

										// if an event handler is defined then call it - only call if deselecting, not selecting
										if (p.onRowDeselected && !$(this).hasClass('trSelected'))
										{
										    p.onRowDeselected($(this)[0].id,$(this),$(this).parent().parent().parent());
										}
									}
							)
							.mousedown(
